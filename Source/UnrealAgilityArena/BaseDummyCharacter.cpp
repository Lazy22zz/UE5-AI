...
ABaseDummyCharacter::ABaseDummyCharacter()
{
	...
	static ConstructorHelpers:: FObjectFinder < UAnimBlueprint > AnimBlueprintAsset( TEXT("/ Game/ KayKit/ PrototypeBits/KayKit/ PrototypeBits/ Character/ ABP_Dummy.ABP_Dummy"));
