...
#include "BehaviorTree/Blackboard/BlackboardKeySelector.h" // Make sure this is included
#include "BTServicce_BatteryCheck.generated.h" // MUST be the last include
